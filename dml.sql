...
--Add Room
INSERT INTO room (room_num, room_type, pets_allowed, max_guests, price) 
  VALUES (:room_num_input, :room_type_input, :pets_allowed_input, :max_guests_input, price_input);

--Update Room
UPDATE room 
  SET room_num = :room_num_input, room_type = :room_type_input, pets_allowed = :pets_allowed_input, max_guests = :max_guests_input, price = :price_input 
...
--Add Reservation
INSERT INTO reservation (guest_id, payment_id, room_num, check_in, check_out, bringing_pets, num_guests, confirmation_num, room_num)  
  VALUES (:guest_id, :payment_id, :room_num, :check_in_input, :check_out_input, :bringing_pets_input, :num_guests_input, :generated_confirmation_num, :room_num_from_browse_rooms_form);

--Update Reservation
UPDATE reservation 
  SET guest_id = :guest_id, payment_id = :payment_id, room_num = :room_num, check_in = :check_in_input, check_out = :check_out_input, num_guests = :num_guests_input, confirmation_num = :generated_confirmation_num, room_num = :room_num_from_browse_rooms_form 
...
--Add Payment
INSERT INTO payment (reservation_id, f_name, l_name, cc_num, cc_type, cc_security_code, house_num, street_name, city, state, zip_code, country, total_charged) 
...
--Update Payment
UPDATE payment 
  SET reservation_id = :reservation_id, f_name = :f_name_input, l_name = :l_name_input, cc_num = :cc_num_input, cc_type = :cc_type_input, cc_security_code = :cc_security_code_input, house_num = :house_num_input, street_name = :street_name_input, city = :city_input, state =:state_input, zip_code = :zip_code_input, country = :country_input, total_charge = :total_charged_from_reservation 
